      ...
      <div className={`ghid-s2-page ${darkTheme ? 'dark-theme' : ''}`}>
        <div className="ghid-s2-container">
          ...
          <section className="ghid-s2-section">
            <h1 className="ghid-s2-section-title">A. Cerințe de tip grilă și răspuns scurt</h1>

            <div className="ghid-s2-block">
              <h2 className="ghid-s2-block-title">1. Tipuri de cerințe</h2>
              <p className="ghid-s2-text">
                Subpunctul A din Subiectul I include cerințe de tip grilă (alegere multiplă) sau răspuns scurt. Acestea verifică înțelegerea literală și inferențială a textului.
              </p>
              <ul className="ghid-s2-list">
                <li>identificarea ideii principale</li>
                <li>recunoașterea informațiilor explicite</li>
                <li>înțelegerea relațiilor cauză-efect</li>
                <li>interpretarea unor elemente din context</li>
              </ul>
            </div>
            ...
            <div className="ghid-s2-block">
              ...
              <p className="ghid-s2-text">
                Citește cu atenție cerința și identifică cuvintele cheie. Caută în text informațiile relevante. La grilă, elimină variantele evident incorecte și compară cele rămase cu textul.
              </p>
              <p className="ghid-s2-text">
                La răspuns scurt, formulează concis, folosind elemente din text. Evită parafrazarea excesivă și răspunsurile prea lungi.
              </p>
            </div>
