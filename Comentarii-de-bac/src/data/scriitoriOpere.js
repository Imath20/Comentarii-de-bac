...
// Funcție helper pentru a obține operele unui scriitor
export function getScriitorOpere(scriitorName) {
  return scriitoriOpere[scriitorName] || scriitoriOpere['eminescu']; // fallback la Eminescu
}